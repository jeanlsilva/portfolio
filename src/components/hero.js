        ...
        <section id="1" className="bg-gray-800 h-screen">
            ...
            <div class="relative z-2 px-10 sm:px-0 max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-6xl m-auto">
                ...
                <div class="h-[90vh] flex flex-col justify-center">
                    <div class="flex flex-col xl:flex-row items-center bg-cyan-900/50 rounded-xl p-3">
                        <div class="flex flex-col justify-center w-full text-center md:text-left xl:max-w-screen-md">
